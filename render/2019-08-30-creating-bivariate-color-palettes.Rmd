...
```{r js_bivariatePalettes, echo = FALSE}
include_url("https://www.joshuastevens.net/images/js_bivariatePalettes.png", height = "175px")
```
...
```{r bivariate-choropleth-echo, eval = FALSE}
library(tidycensus)
...
```{r bivariate-choropleth-eval, results = "hide", echo = FALSE}
library(tidycensus)
